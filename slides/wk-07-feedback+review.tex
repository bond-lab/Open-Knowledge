...
\begin{itemize}
  ...
  \item Major publishers (Springer Nature, Taylor \& Francis, Sage) prohibit or restrict AI in peer review.  The common rules:
    \begin{itemize}
      \item do not upload the manuscript to an AI tool
      \item do not let AI write the review
      \item disclose any assistance you did use
    \end{itemize}
\end{itemize}
\end{frame}
